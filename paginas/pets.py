...
def editar_pet_dialog():
    ...
    with st.form("editar_pet", clear_on_submit=False):
        ...
        with col1:
            ...
            peso_pet = st.number_input("Peso (em kg)", value=pet['peso'], min_value = 0.00, max_value=100.00,
            step = 0.10)
...
with st.form("cadastro_pet", clear_on_submit=True):
    ...
    with col1:
        ...
        peso_pet = st.number_input("Peso (em kg)", value = 0.0, min_value = 0.00, max_value=100.00,
        step = 0.10)
